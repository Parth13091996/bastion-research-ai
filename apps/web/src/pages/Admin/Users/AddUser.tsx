      ...
      <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl">
        ...
        <div>
          ...
          <select id="role" {...register('role')} className="w-full p-2 border rounded">
            ...
            <option value="research_ally_subscriber">Research Ally Subscriber</option>
          </select>
        ...
        <div>
          ...
          {errors.pan_card_number && <p className="text-red-600">{errors.pan_card_number.message}</p>}
        </div>
        <div className="md:col-span-2">
          <label htmlFor="address_1">Address Line 1</label>
          <Input id="address_1" {...register('address_1')} />
          {errors.address_1 && <p className="text-red-600">{errors.address_1.message}</p>}
        </div>
        <div className="md:col-span-2">
        ...
        <div>
          ...
          {errors.pin_code && <p className="text-red-600">{errors.pin_code.message}</p>}
        </div>
        <div>
